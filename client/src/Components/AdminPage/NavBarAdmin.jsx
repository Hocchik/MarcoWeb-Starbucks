...
import MiniPagesFunction from './MiniPagesFunction';
    ...
    >
{
  console.log(pathname)
      ...
      {/* Aqui colocar la logica para separar cada rama de los del menu y esa wea :3 */}
      {/* <Typography>Dashboard content for {pathname}</Typography> */}
      {
        MiniPagesFunction(pathname) 
      }
...
function NavBarAdmin(props) {
  ...
  function logosvg() {
    ...
    return <span>
    <svg version="1.1" viewBox="0 0 50 50" width="40px" height="40px" xmlns="http://www.w3.org/2000/svg">
    <g fill="none">
